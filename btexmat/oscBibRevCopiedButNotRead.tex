...
\subject{Copied-But-Not-Read BiBTeX-Files}
\title{Review}
\subtitle{../btexmat/oscCopiedButNotRead.bib}
\author{K. Reincke\input{oscLicenseFootnoteInc}}
%\thanks{den Autoren von KOMA-Script und denen von Jurabib}
\maketitle
%%-- end(titlepage)

Content of the  BiBTeX-File {\bfseries ../bibfiles/oscCopiedButNotRead.bib}

\small
\bibliography{../bibfiles/oscCopiedButNotRead}
