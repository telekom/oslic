% Telekom osCompendium German bibfile review and integration test
%
...
\author{K. Reincke\input{oscLicenseFootnoteInc}}%\thanks{den Autoren von KOMA-Script und denen von Jurabib}
\maketitle
%%-- end(titlepage)
...
\begin{itemize}
  \item {\bfseries ../bibfiles/oscResourcesEn.bib} :- contains evaluated and verified
...
\small
\bibliography{../bibfiles/oscResourcesEn,../bibfiles/oscNextActions,../bibfiles/oscSomedayMaybe,../bibfiles/oscXtras}
