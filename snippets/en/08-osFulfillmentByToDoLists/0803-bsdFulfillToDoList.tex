...
beginning, it generally \glqq{}(permits) [the] redistribution and [the] use in
source and binary forms, with or without modification, [\ldots]\grqq{}, if one
...
\begin{itemize}
\item For the \glqq{}redistribution of source code\grqq{} the license requires,
that the package must \glqq{} [\ldots] retain the above copyright notice, this
list of conditions and the following disclaimer\grqq{}\footcite[cf.][\nopage
...
modify these files or kind of text snippets. For our purposes, we translated
the bans into the following executable task:

\begin{quote}\glq{}Ensure, that the licensing elements - e.g. the BSD license
text, the specific copyright notice of the original author(s), and the BSD disclaimer
- are retained in your package in the form you have got them.\grq{}\end{quote}

\item For the redistribution in form of binary files, the license requires,
that the licensing elements must be \glqq{}[\ldots] (reproduced) in the documentation
and/or other materials provided with the
distribution\grqq{}\footcite[cf.][\nopage wp]{BsdLicense2Clause}. Hence, this is
...
\begin{quote}\glq{}Let the documentation of your distribution and/or your
additional material also contain the original copyright notice, the BSD
conditions, and the BSD disclaimer.\grq{}\end{quote}

\item Naturally, because the reproduction of the licensing elements \grqq{}in
the documentation and/or other materials provided with the distribution\glqq{}
is explicitly required for the \glqq{}redistribution in binary
form\grqq{}\footcite[cf.][\nopage wp]{BsdLicense2Clause}, we had to rewrite the
...
\begin{quote}\glq{}Ensure, that the documentation of your distribution and/or
your additional material also contain the author specific copyright notice, the
BSD conditions, and the BSD disclaimer.\grq{}\end{quote}
...
\begin{quote}\glq{}Ensure, that your distribution contains the original
...
files into your distribution manually.\grq{}\end{quote}
