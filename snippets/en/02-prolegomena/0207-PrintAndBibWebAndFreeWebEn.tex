...
quoted. Secondly we store all these e-wares\endnote{Take this little word as
(new) generalization of 'e-book', 'e-article', 'e-paper' and so on.} we
read\endnote{But because of the copyright we ourselves are naturally not
...
markers in our bibliographic data\endnote{And another hint: Nowadays sometimes
...
\begin{itemize}
  ...
  free web. In this case we add the url\endnote{Please note: Long urls often
