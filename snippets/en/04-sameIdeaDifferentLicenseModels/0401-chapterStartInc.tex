...
% \begin{center}
% \begin{tabular}[h]{|r|r||c|c|c||c|c||c|c|c|c|c|c||c|c|c|}
% \hline
% & 
% & \rotatebox{90}{ BSD 3-Cl Lic.}
% & \rotatebox{90}{ BSD 2-Cl Lic.}
% & \rotatebox{90}{ MIT Lic. 2.1}
% & \rotatebox{90}{ APL 2.0}
% & \rotatebox{90}{ MsPL 1.0}
% & \rotatebox{90}{ PGL}
% & \rotatebox{90}{ PHP Lic. }
% & \rotatebox{90}{ XYZ Lic. }
% & \rotatebox{90}{ MPL 1.1 }
% & \rotatebox{90}{ MPL 2.1 }
% & \rotatebox{90}{ EPL 1.1 }
% & \rotatebox{90}{ EUPL 2.1 }
% & \rotatebox{90}{ LGPL 2.1 }
% & \rotatebox{90}{ LGPL 3.0}
% \\
% \hline \hline
% users & --
%   & ? & ? & ? & ? & ? 
...
%   & ? & ? & ? & ?\\
% \hline
% contributors, developers, and/or distributors & --
%   & ? & ? & ? & ? & ? 
%   & ? & ? & ? & ? & ? 
%   & ? & ? & ? & ?\\
% \hline
