...
\begin{lsuc}{MSPL-C1}
  ...
  \lsucmeans{that you are going to use a received MS-PL software only for
    yourself and that you do not hand it over to any 3rd party in any sense.}

  \lsuccovers{OSUC-01, OSUC-03, OSUC-06, and OSUC-09\footnote{For details see
...
\begin{lsuc}{MSPL-C2}
  ...
  \lsucmeans{that you are going to distribute an unmodified version of the
    received MS-PL software to third parties in the form of binaries or as
    source code files. In this case it is not discriminating to distribute a
    program, an application, a server, a snippet, a module, a library, or a
    plugin as an independent package.}
...
\begin{lsuc}{MSPL-C3}
  ...
  \lsucmeans{that you are going to distribute a modified version of the received
    MS-PL licensed program, application, or server (proapse) to third parties in
  ...
  \begin{lsucrequires}
    ...
    \lsucoptional{are allowed to expand an existing copyright notice of the
...
\begin{lsuc}{MSPL-C5}
  ...
  \lsucmeans{that you are going to distribute a modified version of the received
    ...
    the form of source code but without embedding it into another larger
    software unit.}
...
\begin{lsuc}{MSPL-C6}
  ...
  \lsucmeans{that you are going to distribute a modified version of the received
    MS-PL code snippet, module, library, or plugin (snimoli) to 3rd parties in
    the form of binary files but without embedding it into another larger
    software unit.}
...
\begin{lsuc}{MSPL-C7}
  ...
  \lsucmeans{that you are going to distribute a modified version of the received
    MS-PL licensed code snippet, module, library, or plugin (snimoli) to 3rd
...
\begin{lsuc}{MSPL-C8}
  ...
  \lsucmeans{that you are going to distribute a modified version of the received
    MS-PL licensed code snippet, module, library, or plugin (snimoli) to third
    parties in the form of a binary package together with another larger
