...
\pstree[levelsep=*1,treesep=0.2]{\Toval{MS-PL}}{
  \pstree{
    ...
    \Tr{\doublebox{\shortstack{\tiny{\textbf{MS-PL-C1}:}\\
  ...
  \pstree[levelsep=*0.2,treesep=0.2]{
    ...
    \pstree[levelsep=*0.2,treesep=0.2]{
      \Tr{\Ovalbox{\shortstack{state:\\\textbf{\textit{unmodified}}}}}
        ...
        \Tr{\doublebox{\shortstack{\tiny{\textbf{MS-PL-C2}:}\\
    ...
    \pstree[levelsep=*0.2,treesep=0.2]{
      ...
      \pstree{
        \Tr{\Ovalbox{\shortstack{type:\\\textbf{\textit{proapse}}}}}
          ...
          \Tr{\doublebox{\shortstack{\tiny{\textbf{MS-PL-C3}:}\\
      ...
      \pstree{
        ...
        \pstree{
          \Tr{\Ovalbox{\shortstack{context:\\\textbf{\textit{independent}}}}}
            ...
            \Tr{\doublebox{\shortstack{\tiny{\textbf{MS-PL-C4}:}\\
            \tiny{\textit{distributing}}\\\tiny{\textit{a modified}}\\
        ...
        \pstree{
          \Tr{\Ovalbox{\shortstack{context:\\\textbf{\textit{embedded}}}}}
            ...
            \Tr{\doublebox{\shortstack{\tiny{\textbf{MS-PL-C5}:}\\
            \tiny{\textit{distributing}}\\\tiny{\textit{a modified}}\\
...
\subsection{MS-PL-C3: Passing a modified program as binary}
...
\subsection{MS-PL-C4: Passing a modified library independently as source code}
...
\subsection{MS-PL-C4: Passing a modified library independently as binary}
...
\subsection{MS-PL-C5: Passing a modified library as embedded source code}
...
\subsection{MS-PL-C5: Passing a modified library as embedded binary}
