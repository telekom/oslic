...
available too.\citeEPL{§3 mid area} More precisely, the EPL has to be taken as a
...
or state is used.\citeEPL{§3 bottom area} So, taken as whole, the EPL mainly
...
\newcommand{\passingFiles}{\footnote{For implementing the handover of files
...
\newcommand{\giveLicenseFile}{Give the recipient a copy of the EPL 1.0 license.
  ...
  that the package is licensed under the EPL, additionally insert your own
...
\newcommand{\noWarranty}[1]{If still not existing, integrate an explicit, very 
  ...
  the no-warranty clause and the disclaimer of liability from the EPL itself
  into that file.} 
...
\begin{lsuc}{EPL-C1}
  ...
  \lsucmeans{that you are going to use the EPL licensed software you received
...
\begin{lsuc}{EPL-C2}
  ...
  \lsucmeans{that you are going to distribute an unmodified version of the
    EPL software that you received to third parties in the form of source code
    files or as a source code package. In this case it makes no difference if
    you distribute a program, an application, a server, a snippet, a module, a
    library, or a plugin and, in the latter cases, if it is distributed as an
  ...
  \begin{lsucrequires}
    ...
    \lsucmandatory{\giveLicenseFile}\passingFiles
...
\begin{lsuc}{EPL-C3}
  ...
  \lsucmeans{that you are going to distribute an unmodified version of the
    EPL software that you received to third parties in the form of binary files
    or as a binary package.  In this case it makes no difference if you
...
\begin{lsuc}{EPL-C4}
  ...
  \lsucmeans{that you are going to distribute a modified version of the EPL
...
The EPL contains a succinct section \enquote{Requirements}\citeEPL{§3}
...
\begin{itemize}
  ...
  \item Additionally, the EPL allows to distribute the software in the form
    ...
    of Liability}\citeEPL{§6} of the EPL must explicitly be present in the
