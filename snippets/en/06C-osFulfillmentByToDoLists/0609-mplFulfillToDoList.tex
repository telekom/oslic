...
\begin{itemize}
  ...
  via a repository: Push the source code package into an internet repository and
  enable its download function without requiring any fee from the downloading
  user. Integrate an easily to find description into your distribution package
...
\begin{itemize}
  ...
  \item \textbf{[volunatry:]} Create a \emph{modification text file}, if such a
...
\begin{itemize}
  ...
  repository and enable its download function without requiring any fee from the
  downloading user. Integrate an easily to find description into your
