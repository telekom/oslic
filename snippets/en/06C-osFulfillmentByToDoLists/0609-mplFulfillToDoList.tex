...
§3.2]{Mpl20OsiLicense2013a}. Additionally, the MPL-2.0 confronts the
...
as whole, the MPL-2.0 mainly focusses on the distribution of software. Thus, for
finding the relevant, simply processable task lists, also the following MPL-2.0
...
\item[means] that you received MPL-2.0 licensed software, that you will use it
...
license with respect to this use case:
  \begin{itemize}
    \item You are allowed to use any kind of MPL-2.0 software in any sense and in
...
\item[means] that you received MPL-2.0 licensed software which you are now
...
\begin{itemize}
  ...
  \item \textbf{[mandatory:]} Execute the to-do list of use case MPL-2.0-C2\footnote{
...
\begin{description}
\item[means] that you received an MPL-2.0 licensed program, application, or
...
\begin{itemize}
  ...
  \item \textbf{[mandatory:]} Execute the to-do list of use case MPL-2.0-C4\footnote{
  Making the code accessible via a repository means distributing the software in
  the form of source code. Hence, you must also fulfill all tasks of the
  corresponding use case.}.
...
\begin{description}
\item[means] that you received an MPL-2.0 licensed code snippet, module, library,
...
\begin{itemize}
  ...
  \item \textbf{[mandatory:]} Execute the to-do list of use case MPL-2.0-6\footnote{
  Making the code accessible via a repository means distributing the software in
  the form of source code. Hence, you must also fulfill all tasks of the
  corresponding use case.}.
...
\begin{itemize}
  ...
  integrated MPL-2.0 and the \emph{licensing files} clearly refer only to the
  ...
  \item \textbf{[voluntary:]} Let the documentation of your distribution and/or
  your additional material also reproduce the content of the existing
  \emph{copyright notice text files}, a hint to the name of the used MPL-2.0
...
\begin{itemize}
  ...
  \item \textbf{[mandatory:]} Execute the to-do list of use case MPL-2.0-C8\footnote{
  Making the code accessible via a repository means distributing the software in
  the form of source code. Hence, you must also fulfill all tasks of the
  corresponding use case.}.
...
\begin{itemize}
  ...
  [MPL-2.0-C1 - MPL-2.0-C9]. But for emphasizing that this is a job which must be activily
  done, the OSLiC additionally rewrites this interdiction into all
  \emph{2others} use cases [MPL-2.0-C2 - MPL-2.0-C9] as the task to retain the licensing
  ...
  §3.1]{Mpl20OsiLicense2013a}. For the respective use case (MPL-2.0-C2, MPL-2.0-C4, MPL-2.0-C6,
  MPL-2.0-C8), the OSLiC rewrites these conditions so that each MPL-2.0 source code
  package must mandatorily contain the MPL-2.0 itself as textfile and an additional
  licensing file or statement strictly following the text given by the addendum
  of the MPL-2.0\footcite[cf.][\nopage wp.\ Exhibit A]{Mpl20OsiLicense2013a}. Because
  the MPL-2.0 is 'only' a license with weak copyleft, the OSLiC proposes to separate
  the MPL-2.0 licensed, embedded component from the overarching program (MPL-2.0-C8).
  
  \item But the MPL-2.0 does not explicitly require to mark all modifications.
  Nevertheless, this is state of the art in computer emgineering. Therefore,
  with respect to the cases of distributing modified source code (MPL-2.0-C4, MPL-2.0-C6
  and MPL-2.0-C8), the OSLiC proposes to mark all modifications inside of the source
  ...
  all cases of distributing it in an \enquote{Executable Form} (MPL-2.0-C3, MPL-2.0-C5,
  MPL-2.0-C7, MPL-2.0-C9) -- \enquote{[\ldots] must also be made available in Source Code
  ...
  MPL-2.0. Thus, in case of distributing binaries (MPL-2.0-C3, MPL-2.0-C5, MPL-2.0-C7, MPL-2.0-C9), the
  OSLiC proposes to insert into the distribution packages the MPL-2.0 itself and an
  additional licensing file or statement strictly following the text given by
  the addendum of the MPL-2.0\footcite[cf.][\nopage wp.\ Exhibit
  A]{Mpl20OsiLicense2013a}. But again, because the MPL-2.0 is 'only' a license with
  weak copyleft, the OSLiC proposes to separate the MPL-2.0 licensed embedded
  component from the overarching program (MPL-2.0-C9).
