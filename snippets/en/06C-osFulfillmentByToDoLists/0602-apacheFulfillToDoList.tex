...
Today, the Apache License Version 2.0 is the current active open source
license, elder versions are depricated\footnote{For details $\rightarrow$ OSLiC,
pp.\ \pageref{sec:ProtectPowerOfApL}}. Because it focusses primarily on the
