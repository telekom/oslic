...
\begin{lsuc}{APL-C1}
  ...
  \lsucmeans{that you received Apache licensed software, that you will use it
...
\begin{lsuc}{APL-C2}
  ...
  \lsucmeans{that you received Apache licensed software which you are now
...
\begin{lsuc}{APL-C4}
  ...
  \lsucmeans{that you received an Apache licensed program, application, or
...
\begin{lsuc}{APL-C6}
  ...
  \lsucmeans{that you received an Apache licensed code snippet, module, library,
