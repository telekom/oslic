...
\newcommand{\auxKeepNoticeFile}[1]{%
  Ensure that the \emph{notice text file} is #1 in your package in the form you
  have initially received it.}  
\newcommand{\keepNoticeFile}{\auxKeepNoticeFile{retained}}
\newcommand{\includeNoticeFile}{\auxKeepNoticeFile{retained or integrated}}

\newcommand{\keepAllNotices}{%
  Ensure that the \emph{notice text file} contains at least all the information
  of that \emph{notice text file} you have received.} 
...
\newcommand{\noTrademarks}{%
  ...
  unpartially describing the used software file.}
\newcommand{\noTrademarksExceptNotice}{%
  ...
  except as required for unpartially describing the used software and for
  reproducing the notice text file.} 
%% \newcommand{\noTrademarksExceptNotice}{%
...
\newcommand{\noPatentLitigation}{%
  to institute any patent litigation against anyone alleging that the software
...
\begin{lsuc}{APL-C1}
  ...
  \lsucmeans{that you are going to use a received Apache licensed software only
  ...
  \begin{lsucrequiresnothing}
    \item You are allowed to use any kind of Apache
    software in any sense and in any context without being obliged to
    do anything as long as you do not give the software to 3rd parties.
...
\begin{lsuc}{APL-C3}
  ...
  \lsucmeans{that you are going to distribute an unmodified version of the
    received Apache software to 3rd parties in the form of binary files or as
    a binary package. In this case it is not discriminating to distribute a
...
\begin{lsuc}{APL-C4}
  ...
  \lsucmeans{that you are going to distribute a modified version of the received 
...
\begin{lsuc}{APL-C5}
  ...
  \lsucmeans{that you are going to distribute a modified version of the received
    Apache licensed pro\-gram, application, or server (proapse) to 3rd parties
    in the form of binary files or as a binary package.}
