...
\label{OSUC-02S-EUPL} \label{OSUC-05S-EUPL} \label{OSUC-07S-EUPL} 

\begin{description}

\item[means] that you are going to distribute an unmodified version of the
received EUPL software to 3rd parties -- in the form of source code files or as
...
\label{OSUC-02B-EUPL} \label{OSUC-05B-EUPL} \label{OSUC-07B-EUPL}

\begin{description}
\item[means] that you are going to distribute an unmodified version of the
received EUPL software to 3rd parties -- in the form of binary files or as a
bi\-na\-ry package. In this case it doesn't matter whether you 
...
\begin{itemize}
  ...
  a mandatory clause for the \emph{2others} use cases (EUPL-2 - EUPL-9).
  ...
  \emph{2others} use cases contain the respective mandatory condition (EUPL-2 -
  EUPL-9).
