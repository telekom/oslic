...
\begin{lsuc}{EUPL-C1}
  ...
  \lsucmeans{that you received EUPL licensed software, that you will use it
...
\begin{lsuc}{EUPL-C2}
  ...
  \lsucmeans{that you received EUPL licensed software which you are now going
...
\begin{lsuc}{EUPL-C3}
  ...
  \lsucmeans{that you received EUPL licensed software which you are now going to
...
\begin{lsuc}{EUPL-C4}
  ...
  \lsucmeans{that you received a EUPL licensed snippet, module or
...
\begin{lsuc}{EUPL-C6}
  ...
  \lsucmeans{that you received a EUPL licensed program, application, or
...
\begin{lsuc}{EUPL-C8}
  ...
  \lsucmeans{that you received a EUPL licensed code snippet, module, library,
