...
\node[slimleaf] (l101) at (0,0) {\textbf{EUPL-01} \textit{using software only
for yourself}};

\node[leaf] (l102) at (1.45,0) { \textbf{EUPL-02} \textit{ distributing unmodified
software as independent sources}};

\node[leaf] (l103) at (3.0,0) { \textbf{EUPL-03}  \textit{ distributing unmodified
software as independent binaries}};

\node[leaf] (l104) at (4.6,0) { \textbf{EUPL-04} \textit{ distributing unmodified
library as embedded sources}};

\node[leaf] (l105) at (6.2,0) { \textbf{EUPL-05}  \textit{ distributing unmodified
library as embedded binaries}};

\node[slimleaf] (l106) at (7.7,0) { \textbf{EUPL-06}  \textit{ distributing modified
program as sources}};

\node[slimleaf] (l107) at (9.1,0) { \textbf{EUPL-07}  \textit{ distributing modified
program as binaries}};

\node[slimleaf] (l108) at (10.5,0) { \textbf{EUPL-08}  \textit{ distributing modified
library as independent sources}};

\node[slimleaf] (l109) at (11.9,0) { \textbf{EUPL-09} \textit{distributing modified
library as independent binaries}};

\node[leaf] (l110) at (13.4,0) { \textbf{EUPL-10}  \textit{distributing
modified library as embedded sources}};

\node[leaf] (l111) at (15,0) { \textbf{EUPL-11}  \textit{ distributing modified
library as embedded binaries}};
...
\subsection{EUPL-01: Using the software only for yourself}
...
\subsection{EUPL-03: Passing the unmodified software as independent binaries} 
...
\subsection{EUPL-05: Passing the unmodified library as embedded binaries} 
\label{OSUC-07B-EUPL}
...
\subsection{EUPL-07: Passing a modified program as binary}
\label{OSUC-04B-EUPL}
...
\subsection{EUPL-09: Passing a modified library as independent binary}
\label{OSUC-08B-EUPL}
