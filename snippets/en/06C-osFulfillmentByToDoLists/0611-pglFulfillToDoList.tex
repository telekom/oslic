...
\pstree[levelsep=*1,treesep=0.2]{\Toval{PgL}}{
  \pstree{
    ...
    \Tr{\doublebox{\shortstack{\tiny{\textbf{PGL-1}:}\\
  ...
  \pstree[levelsep=*0.2,treesep=0.2]{
    ...
    \pstree[levelsep=*0.2,treesep=0.2]{
      \Tr{\Ovalbox{\shortstack{state:\\\textbf{\textit{unmodified}}}}}
        ...
        \Tr{\doublebox{\shortstack{\tiny{\textbf{PGL-2}:}\\
    ...
    \pstree[levelsep=*0.2,treesep=0.2]{
      ...
      \pstree{
        \Tr{\Ovalbox{\shortstack{type:\\\textbf{\textit{proapse}}}}}
          ...
          \Tr{\doublebox{\shortstack{\tiny{\textbf{PGL-3}:}\\
      ...
      \pstree{
        ...
        \pstree{
          \Tr{\Ovalbox{\shortstack{context:\\\textbf{\textit{independent}}}}}
            ...
            \Tr{\doublebox{\shortstack{\tiny{\textbf{PGL-4}:}\\
            \tiny{\textit{distributing}}\\\tiny{\textit{a modified}}\\
        ...
        \pstree{
          \Tr{\Ovalbox{\shortstack{context:\\\textbf{\textit{embedded}}}}}
            ...
            \Tr{\doublebox{\shortstack{\tiny{\textbf{PGL-5}:}\\
            \tiny{\textit{distributing}}\\\tiny{\textit{a modified}}\\
...
\label{OSUC-02-PGL} \label{OSUC-05-PGL} \label{OSUC-07-PGL} 

\begin{description}

\item[means] that you are going to distribute an unmodified version of the
received PGL software to 3rd parties -- regardless whether you distribute it in
the form of binaries or of source code files\footnote{In this case it also
...
whether you distribute it in the form of binaries or of source code files.
\item[covers] OSUC-04\footnote{For details $\rightarrow$ OSLiC, pp.\
\pageref{OSUC-04-DEF}} 
...
\subsection{PGL-4: Passing a modified library independently}
\label{OSUC-08-PGL}
\begin{description}
...
distribute it in the form of binaries or of source code files.
...
it in the form of binaries or of source code files.
