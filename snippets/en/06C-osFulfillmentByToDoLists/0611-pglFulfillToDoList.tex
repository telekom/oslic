...
\newcommand{\giveLicense}{Ensure that the complete PostgreSQL license including
  the copyright notice, the permission notices, and the PostgreSGL disclaimer
...
\begin{lsuc}{PGL-C1}
  ...
  \lsucmeans{that you received PostgreSQL licensed software that you will use
    only for yourself and that you do not hand it over to any third party in any
    sense.} 
  ...
  \begin{lsucrequiresnothing}
    \lsucitem{You are allowed to use any kind of PGL licensed software in any
...
\begin{lsuc}{PGL-C2}
  ...
  \lsucmeans{that you received PostgreSQL licensed software and you are going to
    distribute an unmodified version of the software to third parties regardless
    whether you distribute it in the form of binaries or as source code
    files. In this case it makes no difference to distribute a program, an
...
\begin{lsuc}{PGL-C3}
  ...
  \lsucmeans{that you received a PostgreSQL licensed program, application, or
    server (proapse) and that you are going to distribute a modified version of
    the software to third parties regardless whether you distribute it in the
    form of binaries or as source code files.}
...
\begin{lsuc}{PGL-C4}
  ...
  \lsucmeans{that you received a PostgreSQL licensed code snippet, module,
    library, or plugin (snimoli) and that you are going to distribute a modified
    version of the  to 3rd parties without embedding it into another larger
    software unit regardless whether you distribute it in the form of binaries
...
\begin{lsuc}{PGL-C5}
  ...
  \lsucmeans{that you received a PostgreSQL licensed code snippet, module,
    library, or plugin (snimoli) and that you are going to distribute a modified
    version of the software to third parties together with another larger
    software unit which contains this code snippet, module, library, or plugin
    as an embedded component regardless whether you distribute it in the form of
...
The PGL-License follows the structure of the MIT license: it, too, contains 
