...
\begin{license}{BSD} % ends at end of file
...
The latest release is the \textit{BSD 2-Clause license,}\citeBSDsimple{} the older
release is the \textit{BSD 3-Clause license.}\citeBSDnew{} The very little
differences between the two versions have to be respected exactly. Nevertheless,
we could integrate the requirements into one to-do list per use case.
...
Additionally the BSD licenses consider the form of the distribution,
...
\begin{description}
\item[means] that you received BSD licensed software, that you will use it
...
\begin{description}
\item[means] that you received BSD licensed software which you are now
...
\begin{description}
\item[means] that you received a BSD licensed program, application, or
...
\label{OSUC-08S-BSD}
\begin{description}
\item[means] that you received a BSD licensed code snippet, module, library,
...
license fulfilling elements, or it is not BSD licensed
