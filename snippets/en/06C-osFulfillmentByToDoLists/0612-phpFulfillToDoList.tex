...
\node[leaf] (l11) at (0,0) {\textbf{PHP-1} \textit{using software only
for yourself}};

\node[leaf] (l12) at (1.8,0) { \textbf{PHP-2} \textit{ distributing unmodified
software as sources}};

\node[leaf] (l13) at (3.6,0) { \textbf{PHP-3}  \textit{ distributing unmodified
software as binaries}};

\node[leaf] (l14) at (5.4,0) { \textbf{PHP-4}  \textit{ distributing modified
program as sources}};

\node[leaf] (l15) at (7.2,0) { \textbf{PHP-5}  \textit{ distributing modified
program as binaries}};

\node[leaf] (l16) at (9,0) { \textbf{PHP-6}  \textit{ distributing modified
library as independent sources}};

\node[leaf] (l17) at (10.8,0) { \textbf{PHP-7} \textit{distributing modified
library as independent binaries}};

\node[leaf] (l18) at (12.6,0) { \textbf{PHP-8}  \textit{distributing
modified library as embedded sources}};

\node[leaf] (l19) at (14.4,0) { \textbf{PHP-9}  \textit{ distributing modified
...
\subsection{PHP-1: Using the software only for yourself}
\label{OSUC-01-PHP} 
\label{OSUC-03-PHP} 
\label{OSUC-06-PHP}
\label{OSUC-09-PHP}
...
\subsection{PHP-2: Passing the unmodified software as source code}
...
\subsection{PHP-3: Passing the unmodified software as binary}
...
\subsection{PHP-4: Passing a modified program as source code}
\label{OSUC-04S-PHP}
...
\subsection{PHP-5: Passing a modified program as binary}
\label{OSUC-04B-PHP}
...
\subsection{PHP-6: Passing a modified library as independent source code}
\label{OSUC-08S-PHP}
\begin{description}
\item[means] that you are going to distribute a modified version of the received
...
\subsection{PHP-8: Passing a modified library as embedded source code}
\label{OSUC-10S-PHP}
\begin{description}
\item[means] that you are going to distribute a modified version of the received
PHP code snippet, module, library, or plugin (snimoli) to 3rd parties -- in the
