...
§2]{Php30OsiLicense2013a} . Nevertheless, the PHP-3.0 license focusses only on the
...
\item[means] that you received PHP-3.0 licensed software, that you will use it
...
\item[requires] no tasks in order to fulfill the conditions of the PHP-3.0 license
with respect to this use case:
  \begin{itemize}
    \item You are allowed to use any kind of PHP-3.0 software in any sense and in
...
\begin{description}
\item[means] that you received PHP-3.0 licensed software which you are now
...
\begin{itemize}
  ...
  \item \textbf{[mandatory:]} Ensure that the complete PHP-3.0 license -- esp.\
...
\begin{itemize}
  ...
  \item \textbf{[mandatory:]} Ensure that the complete PHP-3.0 license -- esp.\ the
...
\begin{description}
\item[means] that you received a PHP-3.0 licensed program, application, or
...
\begin{itemize}
  ...
  \emph{reproduce} the complete PHP-3.0 license including the copyright notice, the
...
\begin{itemize}
  ...
  \item \textbf{[voluntary:]} Ensure that the complete PHP-3.0 license -- esp.\ the
  copyright notice, the PHP-3.0 conditions, and the PHP-3.0 disclaimer -- are
...
\label{OSUC-08S-PHP}
\begin{description}
\item[means] that you received a PHP-3.0 licensed code snippet, module, library,
...
\begin{itemize}
  ...
  \item \textbf{[mandatory:]} Let the documentation of your distribution and/or
  your additional material also contain a line of acknowledgment in the form
  \begin{footnotesize}"This product includes PHP-3.0, freely available from
  $\langle$http://www.php.net/$\rangle$"\end{footnotesize}.
...
deals with the PHP-3.0 license. PHP is a script language. Thus, delivering the
source code seems to be a must. But one has to consider that the PHP-3.0 license
