...
received BSD software to 3rd parties in form of a set of source code files or an
...
\item[prohibits] nothing explicitly premised you are using the \emph{BSD 2 Clause
License}. In contrast, the \emph{BSD 3 Clause License} explicitly prohibits to
use the name of the licensing organization or the names of the licensing
distributors to promote your own work.
...
\item For the redistribution in form of binary files, the license requires, that
...
package. But nevertheless, even for a distribution in form of source code, it is
often possible to fulfill this rule too -- e.g.\ if you offer an own download
...
open source use cases which deal with the redistribution in form of source code:
